...
async function main() {
	...
	const result = await generateText({
		...
		prompt:
			"Explain what makes Claude different from other AI assistants in 2 sentences.",
		maxOutputTokens: 150,
	});
		...
		messages: [
			{
				role: "user",
				content:
					"I will give you a long document to analyze. Here it is: " +
	...
	console.log(
		"Note: Claude 3.x models deprecated in 2025, use Claude 4.x instead",
	);
}
