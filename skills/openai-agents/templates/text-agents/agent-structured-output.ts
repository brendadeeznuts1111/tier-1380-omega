...
const contactInfoSchema = z.object({
	...
	reasoning: z
		.string()
		.describe("Brief explanation of how you extracted this information"),
});
...
const sentimentSchema = z.object({
	...
	keyPhrases: z
		.array(z.string())
		.describe("Key phrases that indicate the sentiment"),
...
const sentimentAgent = new Agent({
	...
	instructions:
		"Analyze the sentiment of the given text. Consider tone, word choice, and context.",
...
const taskBreakdownSchema = z.object({
	...
	reasoning: z
		.string()
		.describe("Explanation of how you broke down the project"),
});

const taskPlannerAgent = new Agent({
	name: "Task Planner",
	instructions:
		"Break down project descriptions into concrete tasks with priorities and time estimates.",
