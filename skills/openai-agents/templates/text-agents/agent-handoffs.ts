...
const billingAgent = new Agent({
	...
	handoffDescription:
		"Transfer here for billing, payments, invoices, and refund requests",
...
const technicalAgent = new Agent({
	...
	handoffDescription:
		"Transfer here for technical problems, bugs, feature questions, and system status",
...
async function main() {
	...
	for (const query of queries) {
		...
		try {
			...
			console.log(
				"🤖 Handled by:",
				result.currentAgent?.name || "Triage Agent",
			);
