...
// Basic resize
const thumbnailURL =
	"/cdn-cgi/image/width=300,height=300,fit=cover/uploads/photo.jpg";

// Responsive with auto format (WebP/AVIF)
const responsiveURL =
	"/cdn-cgi/image/width=800,quality=85,format=auto/uploads/hero.jpg";

// Smart crop to face
const avatarURL =
	"/cdn-cgi/image/width=200,height=200,gravity=face,fit=cover/uploads/profile.jpg";
