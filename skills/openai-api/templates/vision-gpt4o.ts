		...
		messages: [
			{
				role: "system",
				content:
					"You are an expert image analyst. Provide detailed, structured analysis of images.",
			},
			{
				role: "user",
				content: [
		...
		messages: [
			{
				...
				content: [
					{
						type: "text",
						text: "List all objects visible in this image with their approximate locations",
					},
					{
						type: "image_url",
						image_url: { url: imageUrl },
		...
		messages: [
			{
				...
				content: [
					{
						type: "text",
						text: "Analyze this image and return structured data",
					},
					{
						type: "image_url",
						image_url: { url: imageUrl },
