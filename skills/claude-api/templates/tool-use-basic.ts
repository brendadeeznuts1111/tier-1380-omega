	...
	basicToolUse()
		.then(() => {
			...
			return toolExecutionLoop(
				"What is the weather in London and what time is it there?",
			);
		})
		.then(() => {
			console.log("\n\n=== Multiple Tools ===\n");
...
export {
	basicToolUse,
	toolExecutionLoop,
	multipleToolsInOneTurn,
	toolExecutionWithErrorHandling,
};
