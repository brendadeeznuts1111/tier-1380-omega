...
async function main() {
	...
	const assistant = await openai.beta.assistants.create({
		...
		instructions:
			"You are a helpful tutor. Explain concepts clearly and use code interpreter when helpful.",
		...
		messages: [
			{
				role: "user",
				content:
					"Explain the Fibonacci sequence and calculate the first 10 numbers.",
			},
		],
	});
	...
	console.log(
		"💬 User: Explain the Fibonacci sequence and calculate the first 10 numbers.\n",
	);
	...
	console.log(
		"💬 User: Can you explain how recursion works in that sequence?\n",
	);
	console.log("🤖 Assistant: ");
