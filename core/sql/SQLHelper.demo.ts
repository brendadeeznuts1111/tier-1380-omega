...
console.log('✅ Dynamic column detection - all columns from all objects included\n');
...
const tensionProfiles = [
  ...
  { environment: 'prod', team: 'platform', benchmark: 'tension-test-3', metadata: { score: 95 } }
];
...
console.log('✅ Undefined values are filtered out (respects database defaults)');
console.log('✅ Bulk inserts detect all columns from all objects (fixes data loss bug)');
